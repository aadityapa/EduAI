...
import { ArrowLeft, Clock, FileText, Focus, Video } from 'lucide-react';
...
import { LessonFocusToggle } from '@/components/lesson-focus-toggle';
      ...
      <PageMotion>
        <LessonFocusToggle>
          <div className="space-y-6">
            ...
            <Card className="lesson-focus-content">
              <CardHeader>
              ...
              <CardContent className="space-y-2 text-sm text-muted-foreground">
                ...
                {hubMatch?.subject.courses[0] && (
                  <Button variant="outline" size="sm" asChild>
                    <Link href={`/student/courses/${hubMatch.subject.courses[0].id}`} prefetch>
