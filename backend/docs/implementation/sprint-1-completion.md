...
frontend/shared-ui/ui       Design tokens, Tailwind, Shadcn-style components
backend/shared/auth     RBAC permission matrix + helpers
backend/database Prisma schema + migrations + seed
backend/shared/shared   Types, API envelope utils, role constants
backend/shared/ai       Stub client
frontend/shared-ui/analytics Stub tracker
services/identity-service  NestJS — auth + users (Sprint 1 focus)
services/*        6 other services — package.json scaffolds
backend/infrastructure/docker      PostgreSQL 16 + Redis 7
