...
**Schema:** `packages/database/prisma/schema.prisma` (~1460 lines, 60+ models)
...
- Terraform defines RDS with automated backups (see `infrastructure/terraform/`)
- DR checklist script: `scripts/dr-test-checklist.mjs`
