...
**Date:** 2025-06-21  
**Scope:** `infrastructure/monitoring/`, service health endpoints, Sentry stubs
...
|-----------|------|--------|
| Prometheus config | `infrastructure/monitoring/prometheus.yml` | ✅ Defined |
| Alert rules | `infrastructure/monitoring/alerting-rules.yml` | ✅ Defined |
| Grafana dashboards | `grafana/dashboards/platform-overview.json`, `ai-service.json` | ✅ Defined |
| OpenTelemetry collector | `infrastructure/monitoring/otel-collector-config.yaml` | ✅ Defined |
| Sentry env template | `infrastructure/monitoring/sentry.env.example` | ⚠️ Stub only |
