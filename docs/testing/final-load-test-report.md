...
**Date:** 2025-06-21  
**Tool:** k6 (Grafana k6)  
**Scripts:** `tests/load/k6-student-journey.js`, `tests/load/k6-scale-scenarios.js`  
...
k6 run tests/load/k6-student-journey.js
k6 run --env SCENARIO=5000 tests/load/k6-scale-scenarios.js
```
